...
class QwenTrainer(Trainer):
    ...
    def compute_metrics(self, eval_pred):
        """
        Compute metrics (e.g., BLEU) from the model's generated predictions.
        Assumes that predict_with_generate=True and that a tokenizer is available.
        """
        
        logits, labels = eval_pred
        
        # Replace label values of -100 with pad_token_id (if applicable)
