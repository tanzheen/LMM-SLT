...
def main():
    ...
    parser.add_argument('--new_model_path', type=str, default="unsloth/Qwen2.5-3B-4bit-pruned")
    parser.add_argument('--support_data', type=str, default=None)
    parser.add_argument('--support_lang', default='de', type=str, nargs='+')
    ...
    old_model = AutoModelForImageTextToText.from_pretrained(args.old_model_path).to("cpu")
    ...
    if args.support_data is not None:
        ...
        vocab_counts = count_freq(data_path=args.support_data, 
                                  ...
                                  tokenizer=old_tokenizer,  # 使用旧的tokenizer
